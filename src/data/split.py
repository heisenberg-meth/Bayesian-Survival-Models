...
class StratifiedSurvivalSplitter:
    ...
    def train_val_test_split(
        ...
        # Train indices
        train_idx = np.concatenate([event_indices[:e_train_end], cens_indices[:c_train_end]])
        # Val indices
        val_idx = np.concatenate([event_indices[e_train_end:e_val_end], cens_indices[c_train_end:c_val_end]])
        # Test indices
    ...
    def create_cv_folds(self, df: pd.DataFrame, event_col: str, n_splits: int = 5) -> List[Dict[str, List[int]]]:
        """
