...
def export_gbsg2():
    ...
    random.seed(42)
    n_samples = 686
    fieldnames = ["horTh", "age", "menostat", "tsize", "pnode", "progrec", "estrec", "time", "cens"]
    ...
    for _ in range(n_samples):
        ...
        rows.append({
            "horTh": horTh, "age": age, "menostat": menostat,
            "tsize": tsize, "pnode": pnode, "progrec": progrec,
            "estrec": estrec, "time": time, "cens": cens
        })
...
def export_whas500():
    ...
    random.seed(43)
    n_samples = 500
    fieldnames = ["age", "gender", "hr", "sysbp", "diasbp", "bmi", "cvd", "afb", "sho", "chf", "lenfol", "fstat"]
...
def export_metabric():
    ...
    random.seed(44)
    n_samples = 1904
    fieldnames = ["age", "tumour_stage", "lymph_nodes_positive", "chemotherapy", "hormone_therapy", "PAM50Subtype", "duration", "event"]
    ...
    for _ in range(n_samples):
        rows.append({
            ...
            "tumour_stage": random.choices([1, 2, 3, 4], weights=[0.2, 0.5, 0.25, 0.05])[0],
